"""
ORACLE-TMF  ·  tests/test_adversarial.py
==========================================
Unit tests for the Adversarial Robustness Module (Upgrade 2).
"""
...
def dte():
    """Shared DTE engine instance (trained once)."""
    return DTEEngine()

@pytest.fixture(scope="module")
def tester(dte):
    """Shared adversarial tester instance."""
    return AdversarialRobustnessTester(dte)

@pytest.fixture
def synthetic_artifacts():
    """Create some synthetic artifacts for testing."""
    artifacts = []
    for i in range(10):
...
class TestAdversarialRobustnessTester:
    def test_evaluate_empty(self, tester):
        """Empty artifacts list should return empty report safely."""
    ...
    def test_evaluate_structure(self, tester, synthetic_artifacts):
        """Test the returned dictionary structure and bounds."""
